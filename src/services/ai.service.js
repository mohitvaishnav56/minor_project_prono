...
import openRouterAI from "../utils/openRouter.js"

import { ApiError } from "../utils/ApiError.js";

export const generateChallenge = async () => {
    // 1. Get the raw response string from the Gemini model
    const rawResponse = await openRouterAI(prompt());
    ...
    try {
        ...
        throw new ApiError(500, "Failed to parse AI response into valid JSON", [error.message]);
    }
